...
export default function ButtonPage() {
  ...
  useEffect(() => {
    function getProducts() {
      axios.get(`/api/mattress?page=${page}&limit=20`).then((response) => {
  ...
  const deleteProduct = (id) => {
    axios.delete(`/api/mattress/delete/${id}`).then((response) => {
                  ...
                  <CardBody>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                      <Button
                        ...
                        status="Primary"
                        style={{ maxWidth: '45%' }}
                        onClick={() => router.push(`/mattressess/edit?id=${product._id}`)}
                      >
                        Edit Product
                      </Button>
                      <Button
